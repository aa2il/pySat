...
static char PredictException_docs[] =
    "PredictException()\n";
...
//  {"PredictException", (PyCFunction)PredictException  , METH_VARARGS, PredictException_docs},

static struct PyModuleDef Cpredict =
{
    PyModuleDef_HEAD_INIT,
    "cpredict", /* name of module */
